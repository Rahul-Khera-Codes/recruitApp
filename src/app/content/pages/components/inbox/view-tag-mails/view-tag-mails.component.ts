...
@Component({
  selector: 'm-view-tag-mails',
  templateUrl: './view-tag-mails.component.html',
  styleUrls: ['./view-tag-mails.component.scss']
})
export class ViewTagMailsComponent implements OnInit {
  Math: any;
  emaillist: any;
  loading = false;
  tag_id: string;
  ...
  noOfMails: any;
  tagStatus: any;
  constructor(public _location: Location, public _router: Router, public dialog: MatDialog, public getemails: ApiService, public snackBar: MatSnackBar, public _localStorageService: LocalStorageService, public _commonService: CommonService) { }
  ...
  defaultOpen() {
    this.getemails.getAllTagsMains()
      .subscribe((res) => {
