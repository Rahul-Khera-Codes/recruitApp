...
export class AddTagComponent implements OnInit {
    ...
    removable = true;
    addOnBlur = true;
    constructor(public _apiService: ApiService,private router: Router,private _location: Location, public _snackBar: MatSnackBar, private tagUpdate: ApiService) { }

    ngOnInit() {
        this.tempList = JSON.parse(localStorage.getItem('tempList'));
        this.addTagType = JSON.parse(localStorage.getItem('addTagType'));
